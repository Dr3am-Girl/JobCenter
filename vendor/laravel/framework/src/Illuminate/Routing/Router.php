...
class Router implements BindingRegistrar, RegistrarContract
{
    ...
    public function auth(array $options = [])
    {
        ...
        if ($options['register'] ?? true) {
            ...
            $this->get('register/user', 'Auth\RegisterController@showUserRegistrationForm')->name('register.user');
            $this->post('register/user', 'Auth\RegisterController@userregister');

            $this->get('register/company', 'Auth\RegisterController@showCompanyRegistrationForm')->name('register.company');
            $this->post('register/company', 'Auth\RegisterController@companyregister');
